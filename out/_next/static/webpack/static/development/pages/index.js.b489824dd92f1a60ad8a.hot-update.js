...
})(["border-top:solid 0.5rem #001925;border-bottom:solid 0.5rem #001925;background:#001925;display:flex;align-items:center;justify-content:center;flex-wrap:wrap;font-size:2.5rem;font-weight:bolder;> *{position:relative;flex:1 0 300px;background:black;color:white;overflow:hidden;max-height:300px;:before{content:'';display:block;padding-bottom:80%;}.background{position:absolute;top:0;bottom:0;left:0;right:0;background-size:cover;background-position:center;transition:all 0.5s ease;}:hover > .background{transform:scale(1.1);}.mask{position:absolute;top:0;bottom:0;left:0;right:0;background:linear-gradient( to bottom,transparent,transparent,rgba(0,0,0,0.5) );}span{position:absolute;bottom:0;left:0;opacity:0.6;padding:0.3rem 0.5rem;text-shadow:0 0 20px black,0 0 20px black;}}"]);
...
//# sourceMappingURL=index.js.b489824dd92f1a60ad8a.hot-update.js.map