...
})(["border-top:solid 0.5rem #001925;border-bottom:solid 0.5rem #001925;background:#001925;display:flex;align-items:center;justify-content:center;flex-wrap:wrap;font-size:2.5rem;font-weight:bolder;> *{position:relative;flex:1 0 300px;background:#001925;color:white;overflow:hidden;max-height:300px;:before{content:'';display:block;padding-bottom:80%;}.background{position:absolute;top:0;bottom:0;left:0;right:0;background-size:cover;background-position:center;transition:all 0.5s ease;}:hover > .background{transform:scale(1.1);}.mask{position:absolute;top:0;bottom:0;left:0;right:0;background:linear-gradient( to bottom,transparent,transparent,rgba(0,0,0,0.5) );}span{position:absolute;bottom:0;left:0;opacity:0.6;padding:0.3rem 0.5rem;text-shadow:0 0 20px black,0 0 20px black;}}"]);
...
})(["padding:calc(12vh + 12vw) 5vw;border-top:solid 0.5rem black;background-image:linear-gradient(147deg,#004f6f 0%,#002e48 99%);color:white;display:flex;flex-direction:column;align-items:center;"]);
...
//# sourceMappingURL=index.js.1f392730d7e9e9d6c626.hot-update.js.map