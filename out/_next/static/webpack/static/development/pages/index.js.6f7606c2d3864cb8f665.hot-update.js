...
})(["padding:1rem;margin:0.5rem;appearance:none;background:white;color:#002838;border:0;border-radius:0.5rem;font-size:1.5rem;font-family:'Bebas Neue',sans-serif;box-shadow:0 5px 20px rgba(0,0,0,0.5);transition:all 0.3s ease;:hover{box-shadow:0 20px 40px rgba(0,0,0,0.5);}"]);
...
//# sourceMappingURL=index.js.6f7606c2d3864cb8f665.hot-update.js.map